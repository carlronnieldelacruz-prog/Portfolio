...
- Cleaned company names and text fields
- Standardized industry classifications
- Cleaned country names
- Converted dates into the proper `DATE` format
- Handled `NULL` and blank values
- Populated missing industry values where possible
- Removed records with insufficient data
- Removed temporary columns

[data cleaning project.sql](https://github.com/user-attachments/files/32092556/data.cleaning.project.sql)
-- DATA CLEANING PROJECT

SELECT *
FROM layoffs;

-- First hing, we want to do is to create a staging table with the raw data, which will be our working document to clean the data
